...
if __name__ == '__main__':
    ...
    # test_kps = test_kps[inner_index]
    # front_vec = front_vec[inner_index]
    # front_dis = front_dis[inner_index]
    # back_vec = back_vec[inner_index]
    # back_dis = back_dis[inner_index]
    # ske_mask = ske_mask[inner_index]
    # weit_map = weit_map[inner_index]
    # vis = vis[inner_index]
    # print("test_kps")
    # print(test_kps)
    ...
    # draw_maps_2(front_vec, front_dis, back_vec, back_dis, ske_mask, args.sample_index, "targ")
    # draw_maps_with_one_bone_2(front_vec, front_dis, back_vec, back_dis, ske_mask, args.sample_index, weit_map, "targ")
    ...
    for i, sample in enumerate(val_loader):
        if i == batch_index:
            ...
            break
    model = torch.load(f"trained_model_v1.2/skeleton_model_after_{args.training_epochs}_epochs.pkl")
    ...
    draw_maps_2(pred_front_vec, pred_front_dis, pred_back_vec, pred_back_dis, pred_ske_mask, args.sample_index, "pred")
    ...
    # draw_maps_2(front_vec, front_dis, back_vec, back_dis, ske_mask, args.sample_index, "gaussian_mask")
